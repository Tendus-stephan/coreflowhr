...
BEGIN
  ...
  -- Create default settings with 'Free' plan (requires subscription)
  ...
  VALUES
    ('screening', NEW.id, 'Screening Outreach', 'Sent when candidate is sourced', 'Sourcing',
    ...
    ('interview', NEW.id, 'Interview Invitation', 'Sent to schedule interviews', 'Interview',
    ...
    ('reschedule', NEW.id, 'Interview Reschedule', 'Sent when interview is rescheduled', 'Reschedule',
    ...
    ('rejection', NEW.id, 'Rejection Letter', 'Sent to rejected candidates', 'Rejection',
     'Application Status Update – {job_title} Position at {company_name}',
     'Dear {candidate_name},\n\nThank you for your interest...'),
    ('offer', NEW.id, 'Offer Letter', 'Sent with job offers', 'Offer',
    ...
    ('hired', NEW.id, 'Hired Letter', 'Sent to hired candidates', 'Hired',
  ...
  VALUES
    ('gcal', NEW.id, 'Google Calendar', 'Sync interviews bi-directionally.', false, 'https://upload.wikimedia.org/wikipedia/commons/a/a5/Google_Calendar_icon_%282020%29.svg'),
    ('meet', NEW.id, 'Google Meet', 'Auto-generate video links.', false, 'https://upload.wikimedia.org/wikipedia/commons/9/9b/Google_Meet_icon_%282020%29.svg');
