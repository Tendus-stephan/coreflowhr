-- Update get_offer_approval_by_token to prefer client logo (job → client → logo_url)
-- over workspace logo when the offer's job is linked to a client with a logo.
