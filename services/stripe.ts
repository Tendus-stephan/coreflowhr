...
export const PLANS = {
  basic: {
    ...
    sourcingSources: ['linkedin', 'github'],
  },
  professional: {
    ...
    maxCandidatesPerJob: 'Unlimited' as const,
    maxActiveJobs: 'Unlimited' as const,
    maxCandidatesPerMonth: 'Unlimited' as const,
    sourcingSources: ['linkedin', 'github', 'mightyrecruiter', 'jobspider'],
  },
} as const;
