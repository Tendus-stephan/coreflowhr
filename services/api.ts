        ...
        createInvite: async (email: string, role: UserRole, expiresInDays = 3): Promise<{ token: string; emailError?: string }> => {
            ...
            try {
                ...
                const content = [
                    ...
                    `  <a href="${inviteLink}"`,
                    `     style="display:inline-block;padding:10px 28px;border-radius:999px;background-color:#111827;color:#ffffff;text-decoration:none;font-weight:600;font-size:14px;line-height:1.4;">`,
                    `    Accept invitation`,
                    `  </a>`,
                    `</p>`,
