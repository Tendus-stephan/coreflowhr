        ...
        createInvite: async (email: string, role: UserRole, expiresInDays = 3): Promise<{ token: string; emailError?: string }> => {
            ...
            try {
                ...
                const content = [
                    ...
                    `  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${inviteLink}" style="height:48px;v-text-anchor:middle;width:200px;" arcsize="17%" strokecolor="#111827" fill="t"><v:fill type="tile" color="#111827"/><w:anchorlock/><center style="color:#ffffff;font-family:Arial,sans-serif;font-size:14px;font-weight:700;">Accept Invitation</center></v:roundrect><![endif]-->`,
                    `  <!--[if !mso]><!-->`,
                    `  <a href="${inviteLink}" target="_blank" style="display:inline-block;background-color:#111827;color:#ffffff;padding:13px 28px;border-radius:8px;font-family:Arial,sans-serif;font-size:14px;font-weight:700;text-decoration:none;-webkit-text-size-adjust:none;">Accept Invitation</a>`,
                    `  <!--<![endif]-->`,
                    `</div>`,
